...
- (id) initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(nullable NSString *)reuseIdentifier {
    if ((self = [super initWithStyle:style reuseIdentifier:reuseIdentifier])) {
        ...
        _timeCreated.font = [UIFont fontWithName:@"Lato-Italic" size:17];
        ...
        [self.timeRemaining mas_makeConstraints:^(MASConstraintMaker *make){
            make.right.equalTo(self.timeCreated.mas_right);
            make.centerY.equalTo(self.contentView.mas_centerY).with.offset(15);
            make.width.greaterThanOrEqualTo(@50);
        }];
        _timeRemaining.font = [UIFont fontWithName:@"Lato-Black" size:17];
        ...
        _amountReceived.font = [UIFont fontWithName:@"Lato-Light" size:17];
        ...
        [self.ranking mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.right.equalTo(self.amountReceived.mas_right);
            make.left.equalTo(self.contentView.mas_left).with.offset(20);
            make.top.equalTo(self.amountReceived.mas_top);
            make.bottom.equalTo(self.amountReceived.mas_bottom);
        }];
