...
- (id) initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(nullable NSString *)reuseIdentifier {
    if ((self = [super initWithStyle:style reuseIdentifier:reuseIdentifier])) {
        ...
        _timeCreated.font = [UIFont fontWithName:@"Raleway-Light" size:17];
        _timeCreated.textColor = [UIColor colorWithWhite:0 alpha:1];
        ...
        [self.timeRemaining mas_makeConstraints:^(MASConstraintMaker *make){
            make.left.equalTo(self.timeCreated.mas_right).with.offset(15);
            make.centerY.equalTo(self.contentView.mas_centerY).with.offset(0);
            make.width.greaterThanOrEqualTo(@50);
        }];
        _timeRemaining.font = [UIFont fontWithName:@"Raleway-Bold" size:17];
        _timeRemaining.textColor = [UIColor colorWithWhite:0.0 alpha:0.7];
        ...
        _amountReceived.font = [UIFont fontWithName:@"Raleway-Medium" size:17];
        _amountReceived.textColor = [UIColor colorWithWhite:0.0 alpha:0.8];
...
- (void)setTraits:(PointEntry *)traits
{
    ...
    if(!traits.isSubt)
    {
        ...
        self.ranking.layer.cornerRadius = 5;
        if(traits.amount <= 10){
